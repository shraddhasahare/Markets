...
class PulseIndicator : View {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        init(context, attrs, 0, R.style.PulseIndicator)
    }
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        init(context, attrs, defStyleAttr, R.style.PulseIndicator)
    }
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        val a = context.obtainStyledAttributes(
            attrs, R.styleable.PulseIndicator, defStyleAttr, defStyleRes
        )
        mMinWidth = a.getDimensionPixelSize(R.styleable.PulseIndicator_minWidth, mMinWidth)
        mMaxWidth = a.getDimensionPixelSize(R.styleable.PulseIndicator_maxWidth, mMaxWidth)
        mMinHeight =
            a.getDimensionPixelSize(R.styleable.PulseIndicator_minHeight, mMinHeight)
        mMaxHeight =
            a.getDimensionPixelSize(R.styleable.PulseIndicator_maxHeight, mMaxHeight)
        val indicatorName = a.getString(R.styleable.PulseIndicator_indicatorName)
        mIndicatorColor = a.getColor(R.styleable.PulseIndicator_indicatorColor, Color.WHITE)
     ...
     * for example:
     * 1. Only class Name,like "SimpleIndicator"
    ...
    fun setIndicator(indicatorName: String) {
        ...
        if (!indicatorName.contains(".")) {
            val defaultPackageName: String = javaClass.getPackage().getName()
...
//    }
    ...
    /* override fun onVisibilityChanged(changedView: View, visibility: Int) {
         ...
         Log.d("DEFAULT_INDICATOR","on visibility changed")
    ...
    companion object {
        private const val TAG = "PulseIndicator"
